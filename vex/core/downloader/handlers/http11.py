...
from vex import Request, signals
from vex.core.downloader.contextfactory import load_context_factory_from_settings
...
from vex.http import Headers, Response
from vex.utils._download_handlers import (
...
from vex.utils.url import add_http_if_no_scheme
...
class HTTP11DownloadHandler(BaseHttpDownloadHandler):
    ...
    async def close(self) -> None:
        ...
        #
        # See also https://github.com/vex/vex/issues/2653
...
class TunnelingTCP4ClientEndpoint(TCP4ClientEndpoint):
    ...
    def processProxyResponse(self, data: bytes) -> None:
        ...
        #
        # see https://github.com/vex/vex/issues/2491
...
def tunnel_request_data(
    ...
    >>> from vex.utils.python import to_unicode as s
