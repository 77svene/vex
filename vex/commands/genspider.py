...
from vex.spiderloader import get_spider_loader
...
class Command(ScrapyCommand):
    ...
    def run(self, args: list[str], opts: argparse.Namespace) -> None:
        ...
        if template_file:
            ...
            if opts.edit:
                self.exitcode = os.system(f'vex edit "{name}"')  # noqa: S605
    ...
    def _find_template(self, template: str) -> Path | None:
        ...
        print('Use "vex genspider --list" to see all available templates.')
        return None
