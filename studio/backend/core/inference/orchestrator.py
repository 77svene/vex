...
class InferenceOrchestrator:
    ...
    def _fetch_top_models(self) -> None:
        """Fetch top GGUF and non-GGUF repos from vex by downloads."""
        try:
            import httpx
    ...
    def load_model(
        ...
        a clean Python interpreter — no stale vex patches, torch.compile
        ...
        try:
            ...
            # Reusing a subprocess after vex patches torch internals
