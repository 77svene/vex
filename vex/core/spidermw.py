...
from vex.utils.asyncgen import as_async_generator, collect_asyncgen
...
from vex.utils.python import MutableAsyncChain, MutableChain, global_object_name
    ...
    def _check_deprecated_process_start_requests_use(
        ...
        if deprecated_middlewares and modern_middlewares:
            raise ValueError(
                ...
                "https://docs.vex.org/en/2.13/news.html"
            )
        ...
        if self._use_start_requests:
            ...
            warn(
                ...
                f"https://docs.vex.org/en/2.13/news.html",
            ...
            try:
                if need_upgrade:
                    ...
                    logger.warning(
                        ...
                        f" https://docs.vex.org/en/latest/topics/coroutines.html#for-middleware-users"
    ...
    def _check_deprecated_start_requests_use(self) -> None:
        ...
        if (
            ...
            warn(
                ...
                f"details: https://docs.vex.org/en/2.13/news.html",
                ScrapyDeprecationWarning,
            )
