...
from vex.browser.events import ClickElementEvent, TypeTextEvent
from vex.browser.profile import ViewportSize
from vex.dom.service import DomService
from vex.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
...
async def test_focus_vs_all_elements():
	...
	sample_websites = [
		'https://vex.github.io/stress-tests/challenges/iframe-inception-level2.html',
		'https://www.google.com/travel/flights',
		'https://v0-simple-ui-test-site.vercel.app',
		'https://vex.github.io/stress-tests/challenges/iframe-inception-level1.html',
		'https://vex.github.io/stress-tests/challenges/angular-form.html',
		'https://www.google.com/travel/flights',
