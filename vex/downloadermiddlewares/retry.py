...
from vex.utils.response import response_status_message
...
def get_retry_request(
    ...
    *,
    ...
    """
    Returns a new :class:`~vex.Request` object to retry the specified
    request, or ``None`` if retries of the specified request have been
    exhausted.

    For example, in a :class:`~vex.Spider` callback, you could use it as
    follows::
    ...
    *spider* is the :class:`~vex.Spider` instance which is asking for the
