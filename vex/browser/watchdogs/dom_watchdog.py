...
from vex.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from vex.observability import observe_debug
from vex.utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
	from vex.browser.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from vex.browser.views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from vex.browser.views import BrowserStateSummary, PageInfo
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from vex.browser.views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from vex.browser.views import PageInfo
