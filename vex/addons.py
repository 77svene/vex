...
class AddonManager:
    ...
    def load_settings(self, settings: Settings) -> None:
        ...
        :param settings: The :class:`~vex.settings.Settings` object from \
            which to read the add-on configuration
        :type settings: :class:`~vex.settings.Settings`
        """
    ...
    def load_pre_crawler_settings(cls, settings: BaseSettings) -> None:
        ...
        :param settings: The :class:`~vex.settings.BaseSettings` object from \
