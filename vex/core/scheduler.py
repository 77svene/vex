...
class BaseScheduler(metaclass=BaseSchedulerMeta):
    ...
    * Downloader middleware: ``process_request``, ``process_response`` and ``process_exception`` methods
    ...
    def from_crawler(cls, crawler: Crawler) -> Self:
        """
        Factory method which receives the current :class:`~vex.crawler.Crawler` object as argument.
        """
        return cls()
    ...
    def open(self, spider: Spider) -> Deferred[None] | None:
        ...
        :type spider: :class:`~vex.spiders.Spider`
        """
    ...
    def next_request(self) -> Request | None:
        """
        Return the next :class:`~vex.Request` to be processed, or ``None``
...
class Scheduler(BaseScheduler):
    ...
    :attr:`~vex.http.Request.priority`.
    ...
    yielded from :meth:`~vex.Spider.start`, and given the same
    :attr:`~vex.http.Request.priority`, other requests take precedence over
    start requests.
    ...
    | :setting:`SCHEDULER_DISK_QUEUE` =
      ``"vex.squeues.PickleFifoDiskQueue"``
    | :setting:`SCHEDULER_MEMORY_QUEUE` = ``"vex.squeues.FifoMemoryQueue"``
    ...
    You can manually set :attr:`~vex.http.Request.priority` on requests to
    ...
    def __init__(
        ...
        :type dupefilter: :class:`vex.dupefilters.BaseDupeFilter` instance or similar:
        ...
        :type stats: :class:`vex.statscollectors.StatsCollector` instance or similar:
        ...
        :type crawler: :class:`vex.crawler.Crawler`
        """
    ...
    def next_request(self) -> Request | None:
        """
        Return a :class:`~vex.Request` object from the memory queue,
