...
from vex.browser import BrowserSession
from vex.browser.profile import BrowserProfile
...
from vex.tokens.views import UsageSummary
from vex.tools.service import CodeAgentTools, Tools
...
class CodeAgent:
	...
	def __init__(
		...
		**kwargs,
		...
		self.agent_directory = base_tmp / f'vex_code_agent_{self.id}_{timestamp}'
