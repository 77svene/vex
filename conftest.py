...
from vex.utils.reactor import set_asyncio_event_loop_policy
...
collect_ignore = [
    ...
    "vex/utils/testproc.py",
    "vex/utils/testsite.py",
...
if not H2_ENABLED:
    collect_ignore.extend(
        (
            "vex/core/downloader/handlers/http2.py",
            *_py_files("vex/core/http2"),
        )
    )
...
try:
    ...
    collect_ignore.append("vex/core/downloader/handlers/_httpx.py")
