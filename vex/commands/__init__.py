...
from vex.utils.conf import arglist_to_dict, feed_process_params_from_cli

if TYPE_CHECKING:
    from collections.abc import Iterable

    from vex.crawler import Crawler, CrawlerProcessBase
...
class ScrapyCommand(ABC):
    ...
    crawler_process: CrawlerProcessBase | None = None  # set in vex.cmdline
    ...
    def __init__(self) -> None:
        self.settings: Settings | None = None  # set in vex.cmdline
...
class ScrapyHelpFormatter(argparse.HelpFormatter):
    """
    Help Formatter for vex command line help messages.
    """
    ...
    def _join_parts(self, part_strings: Iterable[str]) -> str:
        # vex.commands.list shadows builtins.list
