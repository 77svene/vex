...
from vex.exceptions import NotConfigured, ScrapyDeprecationWarning
from vex.http import HtmlResponse, Response
from vex.utils.url import escape_ajax
...
class AjaxCrawlMiddleware:
    ...
    def __init__(self, settings: BaseSettings):
        ...
        warn(
            "vex.downloadermiddlewares.ajaxcrawl.AjaxCrawlMiddleware is deprecated"
            " and will be removed in a future Scrapy version.",
            ScrapyDeprecationWarning,
            stacklevel=2,
        )

        # XXX: Google parses at least first 100k bytes; vex's redirect
