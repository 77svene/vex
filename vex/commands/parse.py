...
from vex.commands import BaseRunSpiderCommand
from vex.exceptions import UsageError
from vex.http import Request, Response
from vex.utils import display
from vex.utils.asyncgen import collect_asyncgen
from vex.utils.defer import _schedule_coro, aiter_errback, deferred_from_coro
from vex.utils.log import failure_to_exc_info
from vex.utils.misc import arg_to_iter
from vex.utils.spider import spidercls_for_request
...
if TYPE_CHECKING:
    ...
    from vex.http.request import CallbackT
