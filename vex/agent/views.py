...
from vex.agent.message_manager.views import MessageManagerState
from vex.browser.views import BrowserStateHistory
from vex.dom.views import DEFAULT_INCLUDE_ATTRIBUTES, DOMInteractedElement, DOMSelectorMap

# from vex.dom.history_tree_processor.service import (
# 	DOMElementNode,
# 	DOMHistoryElement,
# 	HistoryTreeProcessor,
# )
# from vex.dom.views import SelectorMap
from vex.filesystem.file_system import FileSystemState
...
class AgentHistoryList(BaseModel, Generic[AgentStructuredOutput]):
	...
	# 	"""
	# 	from vex.agent.playwright_script_generator import PlaywrightScriptGenerator
