"""Configuration system for vex with automatic migration support."""
...
class OldConfig:
	...
	def BROWSER_USE_CLOUD_API_URL(self) -> str:
		url = os.getenv('BROWSER_USE_CLOUD_API_URL', 'https://api.vex.com')
...
class FlatEnvConfig(BaseSettings):
	...
	BROWSER_USE_CLOUD_API_URL: str = Field(default='https://api.vex.com')
...
def load_vex_config() -> dict[str, Any]:
	"""Load vex configuration for MCP components."""
