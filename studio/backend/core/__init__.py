...
def __getattr__(name):
    ...
    # Distributed Training
    if name in ("DistributedTrainingOrchestrator", "get_distributed_training_orchestrator", "DistributedTrainingProgress"):
        from .distributed import DistributedTrainingOrchestrator, get_distributed_training_orchestrator, DistributedTrainingProgress

        globals()["DistributedTrainingOrchestrator"] = DistributedTrainingOrchestrator
        globals()["get_distributed_training_orchestrator"] = get_distributed_training_orchestrator
        globals()["DistributedTrainingProgress"] = DistributedTrainingProgress
        return globals()[name]
