"""
Enhanced snapshot processing for vex DOM tree extraction.
...
from vex.dom.views import DOMRect, EnhancedSnapshotNode
...
def build_snapshot_lookup(
	...
	logger = logging.getLogger('vex.dom.enhanced_snapshot')
