...
from vex.exceptions import IgnoreRequest, NotConfigured
from vex.http import HtmlResponse, Response
from vex.spidermiddlewares.referer import RefererMiddleware
...
from vex.utils.response import get_meta_refresh
...
class BaseRedirectMiddleware:
    ...
    def handle_referer(self, request: Request, response: Response) -> None:
        ...
        *response* that triggered *request*.
        ...
        vex.spidermiddlewares.referer.RefererMiddleware (or of a subclass)
