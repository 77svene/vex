...
from vex import BrowserSession
from vex.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('# Generated from vex code-use session\n')
	lines.append('import asyncio\n')
	lines.append('import json\n')
	lines.append('from vex import BrowserSession\n')
	lines.append('from vex.code_use import create_namespace\n\n')
